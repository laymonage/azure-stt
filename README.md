...
From: https://github.com/Azure-Samples/cognitive-services-speech-sdk/tree/master/quickstart/javascript/browser/from-microphone
...
* The `RequestAuthorizationToken()` function is unused as we don't use authorization tokens. We connect directly to Azure with the Subscription key and Region setting.
